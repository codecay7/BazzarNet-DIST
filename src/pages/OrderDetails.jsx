        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-black/10 p-6 rounded-xl">
              ...
              <select defaultValue={order.status} className="w-full p-3 mb-4 rounded-lg bg-white/10 border border-black/30">
                <option>Pending</option>
                <option>Shipped</option>
                <option>Delivered</option>
                <option>Cancelled</option>
              </select>
              <button onClick={() => toast.success('Order status updated!')} className="w-full bg-[var(--accent)] text-white py-2 px-4 rounded-lg font-medium">Save Changes</button>
            </div>
            <div className="bg-black/10 p-6 rounded-xl">
