    ...
    <section className="w-full max-w-[1200px] my-10">
      ...
      <div className="text-center py-16 px-5 bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] text-white rounded-2xl mx-4 md:py-20 md:px-10">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          ...
          >
            <FontAwesomeIcon icon={faShoppingBag} aria-hidden="true" /> Start Shopping
          </button>
          <button
            className="bg-[var(--accent)] text-white py-2 px-6 rounded-lg flex items-center gap-2 font-medium hover:bg-[var(--accent-dark)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_2px_10px_rgba(0,0,0,0.1)] transition-all duration-300 m-1.5"
            onClick={() => navigate('/login')}
          ...
          >
            <FontAwesomeIcon icon={faStore} aria-hidden="true" /> Become a Vendor
          </button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-[var(--card-bg)] backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-[0_8px_40px_var(--shadow)] hover:-translate-y-1 transition-transform duration-300">
            <div className="flex items-start gap-4">
              <FontAwesomeIcon icon={faStore} className="text-3xl text-[var(--accent)]" aria-hidden="true" />
              <div>
          ...
          <div className="bg-[var(--card-bg)] backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-[0_8px_40px_var(--shadow)] hover:-translate-y-1 transition-transform duration-300">
            <div className="flex items-start gap-4">
              <FontAwesomeIcon icon={faCartPlus} className="text-3xl text-[var(--accent)]" aria-hidden="true" />
              <div>
          ...
          <div className="bg-[var(--card-bg)] backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-[0_8px_40px_var(--shadow)] hover:-translate-y-1 transition-transform duration-300">
            <div className="flex items-start gap-4">
              <FontAwesomeIcon icon={faTruck} className="text-3xl text-[var(--accent)]" aria-hidden="true" />
              <div>
      ...
      <div className="container mx-auto px-5 my-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[var(--card-bg)] backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-[0_8px_40px_var(--shadow)] hover:-translate-y-1 transition-transform duration-300">
            <div className="flex items-start gap-4">
              <FontAwesomeIcon icon={faUser} className="text-3xl text-[var(--accent)]" aria-hidden="true" />
              <div>
        ...
        <div className="space-y-8">
          <div>
            ...
            <input
              ...
              aria-valuetext={`Current distance to store is ${(deliveryTime / 10).toFixed(1)} kilometers`}
            />
          </div>
        </div>
